...
| **Überschuss, über Nacht voll**    | Varianten der Hybrid‑/Überschuss‑Modi, die bei unzureichender PV‑Leistung auf Schnellladen umschalten. Damit ist sichergestellt, dass das Auto am nächsten Morgen auf jeden Fall voll geladen ist.  | Überschuss & Normal  |
| **Hybrid, über Nacht voll**    | Varianten der Hybrid‑/Überschuss‑Modi, die bei unzureichender PV‑Leistung auf Schnellladen umschalten. Damit ist sichergestellt, dass das Auto am nächsten Morgen auf jeden Fall voll geladen ist.  | Hybrid & Normal  |
